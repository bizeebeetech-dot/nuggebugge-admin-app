...
function AppRoutes() {
    return (_jsxs(Routes, { children: [_jsx(Route, { path: "/login", element: _jsx(PublicRoute, { children: _jsx(Login, {}) }) }), _jsx(Route, { path: "/", element: _jsx(ProtectedRoute, { children: _jsx(Home, {}) }) }), _jsx(Route, { path: "/entities", element: _jsx(ProtectedRoute, { children: _jsx(Entities, {}) }) }), _jsx(Route, { path: "/tasks", element: _jsx(ProtectedRoute, { children: _jsx(TaskList, {}) }) }), _jsx(Route, { path: "/tasks/:taskId/students", element: _jsx(ProtectedRoute, { children: _jsx(StudentList, {}) }) }), _jsx(Route, { path: "/users", element: _jsx(ProtectedRoute, { children: _jsx(UserList, {}) }) }), _jsx(Route, { path: "/website/home", element: _jsx(ProtectedRoute, { children: _jsx(WebsiteHome, {}) }) }), _jsx(Route, { path: "/website/activities", element: _jsx(ProtectedRoute, { children: _jsx(WebsiteActivities, {}) }) }), _jsx(Route, { path: "/website/about-us", element: _jsx(ProtectedRoute, { children: _jsx(WebsiteAboutUs, {}) }) }), _jsx(Route, { path: "/website/statistics", element: _jsx(ProtectedRoute, { children: _jsx(WebsiteStatistics, {}) }) })] }));
}
